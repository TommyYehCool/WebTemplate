...
//		System.out.println(">>> test_leetcode_232 --> Pop done, get " + param_4);
	 ...
	 */
	@Test
	public void test_leetcode_269() {
		String[] words1 = new String[] {"wrt", "wrf", "er", "ett", "rftt"};
		String output1 = alienOrder(words1);
		String expectedOutput1 = "wertf";
		assertThat(output1).isEqualTo(expectedOutput1);
		
		String[] words2 = new String[] {"z", "x"};
		String output2 = alienOrder(words2);
		String expectedOutput2 = "zx";
		assertThat(output2).isEqualTo(expectedOutput2);
		
		String[] words3 = new String[] {"z", "x", "z"};
		String output3 = alienOrder(words3);
